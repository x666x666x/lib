...
AppWizard has created this Engine Lib library for you.  

This file contains a summary of what you will find in each of the files that
make up your Engine Lib application.

/////////////////////////////////////////////////////////////////////////////

StdAfx.h, StdAfx.cpp
    These files are used to build a precompiled header (PCH) file
    named Engine Lib.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "Engine Lib.rc" and a "Engine Lib.h" that 
