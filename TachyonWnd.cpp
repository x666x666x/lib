...
BOOL CTachyonWnd::Create()
{
	...
	{
		if (m_Device.m_option.m_dwScreenX != GetSystemMetrics(SM_CXSCREEN) && m_Device.m_option.m_dwScreenY != GetSystemMetrics(SM_CYSCREEN)) dwStyle |= WS_OVERLAPPED | WS_CAPTION;
	}
